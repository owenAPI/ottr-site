  ...
  return (
    ...
    >
      ...
      <div className="absolute top-10 flex justify-between sm:w-[90%] lg:max-w-[1440px]">
        <div>
          <Link
            href="https://drive.google.com/file/d/165N3StfyU2XSX5kWzPZayHizmRYeonTm/view?usp=drive_link"
            target="_blank"
        ...
        >
          ...
          >
            <Image
              ...
              priority
              alt="ottr logo"
              data-blobity-tooltip="Otto the otter"
      ...
      >
        ...
        >
          <p className="z-50 text-center text-[16px] font-medium text-[#e4ded7] md:text-[20px] lg:text-left">
            Quant Trading, Software Development, Venture Capital
            {/* <Link
        ...
        >
          <p className="text-right text-[16px] font-semibold text-[#e4ded7] md:text-[20px]">
            Building a powerhouse based in Philadelphia, Pennsylvania.
          </p>
        </motion.div>
      </div>
    </motion.section>
